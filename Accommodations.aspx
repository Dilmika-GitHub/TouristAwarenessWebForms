<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accommodations.aspx.cs" Inherits="TouristAwarenessWebForms.Accommodations" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Partner Hotels</title>
    <!-- Bootstrap CSS link -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet" />
    <style>
        /* Background image for the entire page */
        body {
            background-image: url('Images/book_a_guide.jpg'); /* Replace with your background image */
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <!-- Center the topic using the .accommodation-header CSS -->
            <h2 class="accommodation-header">Our Partner Hotels in Sri Lanka</h2>
